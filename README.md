...
| MS Word conversion |  ![Dynamic JSON Badge](https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fraw.githubusercontent.com%2Fdmackinnon1%2Foverleaf-research-workspace%2Fmain%2Fpandoc-build-info.json&query=lastBuild&style=flat-square&label=Last%20pandoc%20run&labelColor=blue&color=black)|[Obtain the latest MS Word version](main.docx) (no preview in GitHub, use download option)|
